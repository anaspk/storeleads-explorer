...
// ISO 3166-1 alpha-2 codes, plus XK (Kosovo), which is commonly present in
// commerce datasets even though it is not an officially assigned ISO code.
const COUNTRY_CODES = `
...
export const COUNTRIES: CountryOption[] = COUNTRY_CODES
  .map((code) => ({
    ...
    // Windows does not render regional-indicator emoji as flags consistently.
